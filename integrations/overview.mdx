...
<Card title="Smart Web Scraping" icon="globe">
  **Extract messages from any website without an API**

  Extract messages from sites like Brightwheel, tax portals, or custom internal tools using AI-powered selector detection with visual refinement.

  **Features:**
  - AI-powered selector detection using Claude vision
  - Visual click-to-select tool for refinement
  - Multi-step navigation recording
  - Session management and auto re-login
